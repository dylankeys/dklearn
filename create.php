  ...
  <head>
	...
	<?php
		...
		if (isset($_POST["submit"]))
		{
			...
			$dbQuery=$db->prepare("insert into assignments values (null,:name,:brief,:deadline,:courseid,:visiblity)");
			$dbParams=array('name'=>$name, 'brief'=>$brief, 'deadline'=>$deadline, 'visiblity'=>$visiblity, 'courseid'=>$courseid);
