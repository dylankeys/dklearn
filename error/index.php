  ...
  <head>
	...
	<body>
		...
		<div class="container">
			...
			<img class="centre error" src="../images/error.gif" alt="Error" width="400px" />

			<h1 class="error">404</h1>
			<h2 class="error">"Houston, we have a problem!"</h2>

			<?php

				if(isset($_GET["specific"]) && $_GET["specific"] != null)
				{
					$specific = $_GET["specific"];

					echo '<h5 class="error">'.$specific.'</h5>';
				}

			?>

			<br>
			<p class="centre">Please contact the site administrator if you believe this is a system fault.</p>
			<br>
			<br>
			<br>
