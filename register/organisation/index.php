...
<div class="container">
    ...
    <?php
      ...
      {
         echo "<h2 style='color:red'>Unique name already exists, try another</h2>";
      }
    ?>

    <table align="center">
        <tr>
            <td><h2>Enter details to register your organisation</h2></td>
        </tr>

        <tr>
            <td><h4>Organisation details</h4></td>
        </tr>
	    ...
	    <form id="contactForm" method="post" action="register.php">
          ...
          <tr>
             <td>
                  <label for="org">Organisation name</label>&nbsp;<input type="text" class="form-control" name="org" placeholder="Organisation name">
             </td>
          </tr>

         <tr>
            <td>
               <label for="unique">Unique name (no spaces, all lowercase)</label>&nbsp;<input type="text" class="form-control" name="unique" placeholder="Unique name">
             </td>
          </tr>

          <tr>
             <td>
                <label for="colour">Theme colour</label>&nbsp;<input type="color" class="form-control" name="colour">
              </td>
           </tr>

          <tr>
              <td><h4>Organisation administrator</h4></td>
          </tr>
